...
@MediumTest //it takes a medium time
...
class TaskDetailFragmentTest {
    ...
    fun completedTaskDetails_DisplayedInUi() = runBlockingTest {
        ...
        val task = Task("Active Task", "AndroidX Rocks", true)
    ...
    @Test
    fun completedTaskDetails_DisplayedInUi_correct() = runBlockingTest{
        // GIVEN - Add completed task to the DB
